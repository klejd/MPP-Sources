...
public class EmployeeTestData {
	...
	static {
		addresses.add(new Address("101 Main", "Fairfield", "IA", "53556"));
		...
		addresses.add(new Address("13141 W. Stevens", "Fairfield", "IA", "53556"));
		...
		addresses.add(new Address("500 Main", "Fairfield", "IA", "53556"));
		...
		list.add(new Employee("Tom", 150000, 1958, addresses.get(10)));
